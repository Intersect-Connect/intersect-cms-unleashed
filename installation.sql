...
INSERT INTO `cms_pages` (`id`, `category`, `unique_slug`, `name`, `content`, `is_visible`) VALUES (NULL, 'Legal', 'legal-notice', 'Legal Notice', '<p>your text</p>', '1'), (NULL, 'Legal', 'terms-and-conditions', 'Terms and conditions', '<p>your text<p>', '1'), (NULL, 'Legal', 'confidentiality', 'Confidentiality', '<p>your text<p>', '1');
